...
function CompanyFooter({name, surname, position, phone, email, cName, cAddress, cStreet, cNip, cMail, cPhone}) {

  var phoneResult = phone.substr(0, 3) + " " + phone.substr(3, 3) + " " + phone.substr(6, 3);
    return (
      <>
          <div id="divtocopy" style={{padding:"20px"}}>
              <table cellpadding="0" width="600" cellspacing="0" style={{verticalAlign:"-webkit-baseline-middle",fontSize:"medium",fontFamily:"Arial",color:"#000",backgroundColor:"#fff"}}>
                  ...
                  <table cellpadding="0" cellspacing="0" border="0" align="center" width="500">
                    <tr>
                      <td cellpadding="0" cellspacing="0" border="0" height="1">
                        <img src="/" width="500" height="1" style={{display:"block",maxHeight:"1px",minHeight:"1px",minWidth:"500px",width:"500px"}} alt=""/>
                      </td>
                    </tr>
                  </table>
                </td>
                  ...
                  <table width="100%">
                    <tr>
                      <td style={{width:"200px",textAlign:"left"}}>
                        <img style={{verticalAlign:"middle",borderRadius:'6px'}} src="/" alt="avatar" width="150px"/>
                      </td>
                    ...
                    <tr>
                      <td style={{width: "280px"}}>
                        <table style={{borderSpacing:"0"}}>
                          <tr>
                            <td>
                              <img src="/" alt="" style={{verticalAlign: "middle", width: "125px", height: "auto"}}/>
                            </td>
                            <td style={{lineHeight:"13px",fontSize:"10px",fontFamily:"Arial",color:"rgb(0, 0, 0)",fontWeight:"400",padding:"0 20px 0 40px"}}>
                      ...
                      <td>
                        <table style={{borderSpacing:"0"}}>
                          <tr>
                            <td style={{width:"140px",lineHeight:"13px",fontSize:"10px",fontFamily:"Arial",color:"rgb(0, 0, 0)",fontWeight:"400",padding:"0"}}>
                              NIP:{cNip} 
                              <br/>{cMail} 
                              <br/>tel. {cPhone}
                            </td>
                              ...
                              <td style={{textAlign:"right",width:"200px"}}>
                                <span style={{display:"inline-block"}}>
                                  <a style={{display:"inline-block",textDecoration:"none",marginRight:"12px"}} href="/">
                                    <img style={{verticalAlign:"bottom",width:"20px"}} src="/" alt=""/>
                                  </a>
                                  <a style={{display:"inline-block",textDecoration:"none",marginRight:"12px"}} href="/">
                                    <img style={{verticalAlign: "bottom",width: "20px"}} src="/" alt=""/>
                                  </a>
                                  <a style={{display:"inline-block",textDecoration:"none",marginRight:"12px"}} href="/">
                                    <img style={{verticalAlign:"bottom",width:"20px",display:"inline-block"}} src="/" alt=""/>
                                  </a>
                                  <a style={{display:"inline-block",textDecoration:"none",marginRight:"12px"}} href="/">
                                    <img style={{verticalAlign:"bottom",width:"20px"}} src="/" alt=""/>
                                  </a>
